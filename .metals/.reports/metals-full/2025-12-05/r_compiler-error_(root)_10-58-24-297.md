...
### dotty.tools.dotc.ast.Trees$UnAssignedTypeException: type of TypeApply(Select(Apply(Ident(api),List()),->),List(Ident(<error>))) is not assigned
...
class AirlineApp[System, Api[_]](using systemDsl: SystemDsl[System, Api], apiDsl: ApiDsl[Api]):
  ...
  def airlineSystem: System =
    ...
    system("airline")
      .public[Company](
        api(Endpoint.ReadResourceEndpoints)./[Flight](
